...
class SRModule(MriModule):                                                                                                                                                                      
    ...
    def training_step(self, batch, batch_idx):
        image, target, mean, std, fname, slice_num, _ = batch[1]#pdfs
        imagepd, targetpd, meanpd, stdpd, fnamepd, slice_numpd, _ = batch[0]#pd
    ...
    def validation_step(self, batch, batch_idx):
        image, target, mean, std, fname, slice_num, max_value = batch[1]#pdfs
        imagepd, targetpd, meanpd, stdpd, fnamepd, slice_numpd, _= batch[0]#pd
...
class DataTransform(object):
    ...
    def __call__(self, kspace, mask, target, attrs, fname, slice_num):
        ...
        return LR_image, target, mean, std, fname, slice_num, max_value
