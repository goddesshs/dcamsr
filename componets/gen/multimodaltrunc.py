...
def main():
    ...
    praser.add_argument('--dim-pca', '-dim', type=int, help='Number of dimensions to use for the PCA', default=3)
...
def get_centroids(
    ...
    if plot_pca:
        ...
        ax1.scatter(*axes_s, c=color[:plot_samples], cmap='tab20c', edgecolor='k', s=20, alpha=0.4)
